    ...
    targets: [
        .target(
            ...
            sources: [
                "Core/Locked.swift",
                "Core/Log.swift",
                "Core/LoginShellEnvironment.swift",
                "Core/MobilePlatform.swift",
                "Core/Shell.swift",
                ...
                "Features/ReleaseNotes/ClaudeCLI.swift",
                "Features/ReleaseNotes/ReleaseNotesBuilder.swift",
                "Features/ReleaseNotes/ReleaseNotesGenerator.swift",
                "Features/ReleaseNotes/ReleaseNotesModels.swift",
                "Features/Simulators/SimulatorModels.swift",
                "Features/Simulators/SimulatorParsing.swift",
                "Features/Simulators/SimulatorRunner.swift",
